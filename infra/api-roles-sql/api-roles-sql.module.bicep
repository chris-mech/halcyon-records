...
resource script_sql_halcyonrecords 'Microsoft.Resources/deploymentScripts@2023-08-01' = {
  name: take('script-${uniqueString('sql', principalName, 'halcyonrecords', resourceGroup().id)}', 24)
  location: location
  identity: {
    type: 'UserAssigned'
