        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Albums_OriginalPriceInPence_GreaterThanPrice", "OriginalPriceInPence IS NULL OR OriginalPriceInPence > PriceInPence");
                    table.CheckConstraint("CK_Albums_PriceInPence_NotNegative", "PriceInPence >= 0");
                    table.CheckConstraint("CK_Albums_Title_NotEmpty", "LEN(Title) > 0");
                    table.CheckConstraint("CK_Albums_UnitsInStock_NotNegative", "UnitsInStock >= 0");
                });
