...
namespace HalcyonRecords.Api.Infrastructure.Migrations
{
    ...
    [Migration("20260822134056_AddBackgroundJobSupport")]
    partial class AddBackgroundJobSupport
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HalcyonRecords.Api.Domain.Album", b =>
                {
                    ...
                    b.Property<int>("RestockUnitsInStock")
                        .HasColumnType("int");
                    ...
                    b.ToTable("Albums", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Albums_RestockUnitsInStock_NotNegative", "RestockUnitsInStock >= 0");
            ...
            modelBuilder.Entity("HalcyonRecords.Api.Domain.User", b =>
                {
                    ...
                    b.Property<bool>("IsShowcaseAccount")
                        .HasColumnType("bit");
